...
function getMatches(tileGrid){
    ...
    // column 1
    if (tileGrid[0][0].tileType === tileGrid[0][1].tileType &&
        tileGrid[0][1].tileType === tileGrid[0][2].tileType
    ) {
        matches.push([tileGrid[0][0], tileGrid[0][1], tileGrid[0][2]]);
    }

    // column 2
    if (tileGrid[1][0].tileType === tileGrid[1][1].tileType &&
        tileGrid[1][1].tileType === tileGrid[1][2].tileType
    ) {
        matches.push([tileGrid[1][0], tileGrid[1][1], tileGrid[1][2]]);
    }

    // column 3
    if (tileGrid[2][0].tileType === tileGrid[2][1].tileType &&
        tileGrid[2][1].tileType === tileGrid[2][2].tileType
    ) {
        matches.push([tileGrid[2][0], tileGrid[2][1], tileGrid[2][2]]);
    }

    // row 1
    if (tileGrid[0][0].tileType === tileGrid[1][0].tileType &&
        tileGrid[1][0].tileType === tileGrid[2][0].tileType
    ) {
        matches.push([tileGrid[0][0], tileGrid[1][0], tileGrid[2][0]]);
    }

    // row 2
    if (tileGrid[0][1].tileType === tileGrid[1][1].tileType &&
        tileGrid[1][1].tileType === tileGrid[2][1].tileType
    ) {
        matches.push([tileGrid[0][1], tileGrid[1][1], tileGrid[2][1]]);
    }

    // row 3
    if (tileGrid[0][2].tileType === tileGrid[1][2].tileType &&
        tileGrid[1][2].tileType === tileGrid[2][2].tileType
    ) {
        matches.push([tileGrid[0][2], tileGrid[1][2], tileGrid[2][2]]);
    }
