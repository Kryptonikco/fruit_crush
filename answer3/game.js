...
function update() {
    ...
    // console.log("#update me.game.input.x", me.game.input.x);
    // console.log("#update me.game.input.y", me.game.input.y);

    // console.log("#update me.activeTile1", me.activeTile1);
    // console.log("#update me.activeTile2", me.activeTile2);
...
function addTile(x, y, type = null) {
    ...
    var tileToAdd = type || me.tileTypes[me.random.integerInRange(0, me.tileTypes.length - 1)];
...
function checkMatch(){
    ...
    console.log("#checkMatch matches", matches);
...
function createScore(){
    ...
    me.scoreLabel = me.game.add.text(me.tileGrid[0].length * me.tileWidth, (me.tileGrid.length - 1) * me.tileHeight / 2, 0, {font: scoreFont, fill: "#fff"});
...
function incrementScore(){
    ...
    me.scoreLabel.setText(me.score);        
